...
recorded as the resolved Phase 2.0 finding in
[ROADMAP.md](../../ROADMAP.md). Results depend on the calibrated jaw pads and
the deterministic scene; they are not hardware or randomized results.
